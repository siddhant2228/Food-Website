  ...
  return (
    ...
    <div className=' max-w-[1640px] m-auto px-4 py-12 '>
      ...
      <div className=' flex flex-col lg:flex-row justify-between '>
       ...
       <button onClick={()=> filterPrice('$')} className=' m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '> Rs</button>
       <button onClick={()=> filterPrice('$$')} className=' m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '> Rss</button>
       <button onClick={()=> filterPrice('$$$')} className=' m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '> Rsss</button>
       <button onClick={()=> filterPrice('$$$$')} className=' m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white '> Rssss</button>
       </div>
      ...
      <div className=' grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4 '>
       ...
       {foods.map ((item , index)=>(
        <div  key={ index }  className=' border shadow-lg rounded-lg hover:scale-110 duration-500 '>
