    ...
    <div className='max-w-[1640px] mx-auto p-4 py-4 grid md:grid-cols-3 gap-6 ' >
        ...
        <div className=' rounded-xl relative ' >
           {/* Overlay */}
            ...
            <img 
            className=' mx-h-[160px]  md:max-h-[200px] w-full object-cover rounded-xl '
            src='https://images.pexels.com/photos/1861785/pexels-photo-1861785.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' 
            alt=''
             />
        ...
        <div className=' rounded-xl relative ' >
           {/* Overlay */}
            <div className=' absolute w-full h-full bg-black/50 rounded-xl text-white '>
              <p className=' font-bold text-2xl px-2 pt-4 '>  We Delivered Deserts Too</p>
